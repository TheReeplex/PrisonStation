...
var/list/dreams = list(
	"an ID card","a bottle","a familiar face","a crewmember","a toolbox","a security officer","the Prison Administrator",
	...
	"a blue light","an abandoned laboratory","NanoTrasen","OmniWatch","mercenaries","blood","healing","power","respect",
