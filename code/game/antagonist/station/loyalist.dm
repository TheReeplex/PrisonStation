...
/datum/antagonist/loyalists
	...
	faction_welcome = "Preserve Prison Station interests against the traitorous recidivists amongst the crew. Protect the heads of staff with your life." // Prison Station TODO
