...
/datum/antagonist/revolutionary
	...
	restricted_jobs = list("Internal Affairs Agent", "AI", "Cyborg", "Prison Administrator", "Head of Personnel", "Head of Security", "Chief Engineer", "Research Director", "Chief Medical Officer")
